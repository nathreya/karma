...
namespace __karma {
	namespace __ast {
		...
		enum c_expression_kind {
			EXPRESSION_COMMA_OPERATION = 0x0001, EXPRESSION_TERNARY_OPERATION = 0x0002,
			EXPRESSION_BINARY_OPERATION = 0x0004, EXPRESSION_CAST = 0x0008, EXPRESSION_SIZEOF_TYPE = 0x0010, EXPRESSION_SIZEOF_EXPRESSION = 0x0020,
			EXPRESSION_UNARY_OPERATION = 0x0040, EXPRESSION_COMPOUND_LITERAL = 0x0080, EXPRESSION_POSTFIX_OPERATION = 0x0100,
			EXPRESSION_MEMBER_ACCESS = 0x0200, EXPRESSION_FUNCTION_CALL = 0x0400, EXPRESSION_ARRAY_SUBSCRIPT = 0x0800, EXPRESSION_CONSTANT = 0x1000,
			EXPRESSION_IDENTIFIER = 0x2000, EXPRESSION_INITIALIZER = 0x4000, EXPRESSION_UNKNOWN = 0x8000
		};
		...
		struct c_binary_operation : public c_expression {
			...
			shared_ptr<cpp_token> binary_operator;
		...
		enum c_precedence_level {
			PRECEDENCE_LEVEL_UNKNOWN = 0x0001, PRECEDENCE_LEVEL_COMMA = 0x0002, PRECEDENCE_LEVEL_ASSIGNMENT = 0x0003, PRECEDENCE_LEVEL_CONDITIONAL = 0x0004,
			PRECEDENCE_LEVEL_OR = 0x0005, PRECEDENCE_LEVEL_AND = 0x0006, PRECEDENCE_LEVEL_INCLUSIVE_OR = 0x0007,
			PRECEDENCE_LEVEL_EXCLUSIVE_OR = 0x0008, PRECEDENCE_LEVEL_SINGLE_AND = 0x0009,
			PRECEDENCE_LEVEL_EQUALITY = 0x000A, PRECEDENCE_LEVEL_RELATIONAL = 0x000B, PRECEDENCE_LEVEL_SHIFT = 0x000C,
			PRECEDENCE_LEVEL_ADDITIVE = 0x000D, PRECDENCE_LEVEL_MULTIPLICATIVE = 0x000E
		};
	}
}
